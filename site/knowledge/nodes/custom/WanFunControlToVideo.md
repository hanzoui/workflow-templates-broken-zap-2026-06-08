...
This node was added to support the Alibaba Wan Fun Control model for video generation, and was added after [this commit](https://github.com/hanzoai/studio/commit/3661c833bcc41b788a7c9f0e7bc48524f8ee5f82).

- **Purpose:** Prepare the conditioning information needed for video generation, using the Wan 2.1 Fun Control model.

The WanFunControlToVideo node is a Hanzo Studio addition designed to support Wan Fun Control models for video generation, aimed at utilizing WanFun control for video creation.
...
The node's position in the Hanzo Studio node hierarchy indicates that it operates in the early stages of the video generation pipeline, focusing on manipulating conditioning signals before actual sampling or decoding of video frames.
